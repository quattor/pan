/*
 ...
 $HeadURL: https://svn.lal.in2p3.fr/LCG/QWG/panc/trunk/src/org/quattor/pan/dml/operators/LogicalLETest.java $
 $Id: LogicalLETest.java 3550 2008-08-02 14:54:26Z loomis $
 */
...
public class LogicalLETest extends AbstractOperationTestUtils {
	...
	public void testLongs() throws SyntaxException {
		...
		Operation lle = LogicalLE.newOperation(null, LongProperty
				.getInstance(va), LongProperty.getInstance(vb));

		// Pull the value off the stack.
		assertTrue(lle instanceof BooleanProperty);
		BooleanProperty result = (BooleanProperty) lle;
	...
	public void testDoubles() throws SyntaxException {
		...
		// Execute the operations.
		Operation lle = LogicalLE.newOperation(null, DoubleProperty
	...
	public void testString() throws SyntaxException {
		...
		// Execute the operations.
		Operation lle = LogicalLE.newOperation(null, StringProperty
