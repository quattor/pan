/*
 ...
 $HeadURL: https://svn.lal.in2p3.fr/LCG/QWG/panc/trunk/src/org/quattor/pan/dml/operators/LogicalNETest.java $
 $Id: LogicalNETest.java 3550 2008-08-02 14:54:26Z loomis $
 */
...
public class LogicalNETest extends AbstractOperationTestUtils {
	...
	public void testLongs() throws SyntaxException {
		...
		Operation lne = LogicalNE.newOperation(null, LongProperty
	...
	public void testDoubles() throws SyntaxException {
		...
		// Execute the operations.
		Operation lne = LogicalNE.newOperation(null, DoubleProperty
	...
	public void testString() throws SyntaxException {
		...
		// Execute the operations.
		Operation lne = LogicalNE.newOperation(null, StringProperty
