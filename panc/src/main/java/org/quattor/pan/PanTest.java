...
import static org.quattor.pan.TestUtils.*;
...
public class PanTest {
    ...
    public static void main(String[] args) throws SyntaxException {
            ...
            prop.setProperty("panc.testdir", "/Users/isaura/Desktop/pan/panc/src/test/pan");
            prop.setProperty("panc.tmpdir", "/Users/isaura/Desktop/test/temp/");
    ...
    public static void runTests() throws SyntaxException {
        ...
        javaDependencyTests();
        javaFunctionalTests();
        javaRootElementTests();

    }


    protected static Compiler getDefaultCompiler(File tplfile, File dir,
                                                 org.quattor.pan.output.Formatter formatter) throws SyntaxException {
        List<File> path = new LinkedList<File>();
        path.add(dir);
        Set<org.quattor.pan.output.Formatter> formatters = new TreeSet<org.quattor.pan.output.Formatter>(
    ...
    protected static Compiler getRootElementCompiler(File tplfile, File dir,
                                                     org.quattor.pan.output.Formatter formatter) throws SyntaxException {
        List<File> path = new LinkedList<File>();
        path.add(dir);
        Set<org.quattor.pan.output.Formatter> formatters = new TreeSet<org.quattor.pan.output.Formatter>(
    ...
    protected static Compiler getDependencyCompiler(File tplfile, File dir)
            throws SyntaxException {
        List<File> path = new LinkedList<File>();
        path.add(dir);
        org.quattor.pan.output.Formatter formatter = PanFormatter.getInstance();
        Set<org.quattor.pan.output.Formatter> formatters = new TreeSet<org.quattor.pan.output.Formatter>(
                FormatterComparator.getInstance());
        formatters.add(formatter);
        formatters.add(DepFormatter.getInstance());
    ...
    public static void javaFunctionalTests() throws SyntaxException {
    ...
    public static void javaRootElementTests() throws SyntaxException {
     ...
     */
    protected static String invokeTest(File rootdir, File objtpl,
        ...
        org.quattor.pan.output.Formatter formatter = extractFormatter(objtpl);
        ...
        if (expectation instanceof ExceptionChecker) {

            // Cast to an exception class.
            ExceptionChecker checker = (ExceptionChecker) expectation;
    ...
    public static void javaDependencyTests() throws SyntaxException {
     ...
     * @return message (String) if there is an error, null otherwise
     */
    protected static String invokeDependencyTest(File rootdir, File objtpl)
            throws SyntaxException {
