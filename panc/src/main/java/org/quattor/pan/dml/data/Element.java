...
public interface Element extends Operation {
    ...
    /**
     * Determine if the given Element is Persistent. Persistent Elements are valid entries in a final configuration
     * tree.
     */
    public boolean isPersistent();

    /**
     * Determine if the given Element is Transient. Transient Elements are only valid while building the tree. They may
     * not appear in the final configuration tree.
     */
     ...
     *
     * Subclasses MUST override this method appropriately. This default method will work only for elements which are not
     * containers and not a transient element.
     *
