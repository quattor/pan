/*
 ...
 $HeadURL: https://svn.lal.in2p3.fr/LCG/QWG/panc/trunk/src/org/quattor/pan/dml/operators/BitAnd.java $
 $Id: BitAnd.java 3515 2008-07-31 13:20:05Z loomis $
 */

package org.quattor.pan.dml.operators;

import static org.quattor.pan.utils.MessageUtils.MSG_INVALID_ARGS_BITAND;
		...
		if (ops[0] instanceof Element && ops[1] instanceof Element) {
			...
			try {
				...
				throw new EvaluationException(MessageUtils
						.format(MSG_INVALID_ARGS_BITAND), sourceRange);
			} catch (EvaluationException ee) {
				throw SyntaxException.create(sourceRange, ee);
			}

		} else {
			result = new BitAnd(sourceRange, ops);
		}
