...
public class DepGzipFormatter extends DepFormatter {

	private static final DepGzipFormatter instance = new DepGzipFormatter();

	private DepGzipFormatter() {
		super("dep.gz", "dep.gz");
	}

	public static DepGzipFormatter getInstance() {
		return instance;
	}
