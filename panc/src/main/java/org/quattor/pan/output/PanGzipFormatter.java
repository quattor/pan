...
public class PanGzipFormatter extends PanFormatter {

	private static final PanGzipFormatter instance = new PanGzipFormatter();

	private PanGzipFormatter() {
		super("xml.gz", "pan.gz");
	}

	public static PanGzipFormatter getInstance() {
		return instance;
	}
