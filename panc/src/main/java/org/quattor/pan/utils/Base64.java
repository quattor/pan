/*
 ...
 $HeadURL: https://svn.lal.in2p3.fr/LCG/QWG/panc/trunk/src/org/quattor/pan/utils/Base64.java $
 $Id: Base64.java 2711 2008-01-13 20:31:46Z loomis $
 */
	...
	public static byte[] decode(byte[] source) {
		...
		for (i = off; i < off + len; i++) {
			...
			// better
			{
				...
				throw new EvaluationException("Bad Base64 input character at "
						+ i + ": " + source[i] + "(decimal)");
			} // end else:
