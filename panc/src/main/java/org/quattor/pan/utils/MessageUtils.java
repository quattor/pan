...
public class MessageUtils {
    ...
    public final static String MSG_CANNOT_MODIFY_GLOBAL_VARIABLE_FROM_DML =
            "MSG_CANNOT_MODIFY_GLOBAL_VARIABLE_FROM_DML";

    public final static String MSG_VALUE_AT_PATH_UNDEFINED = "MSG_VALUE_AT_PATH_UNDEFINED";

    public final static String MSG_VALIDATION_FAILED_BECAUSE_OF_EXCEPTION =
            "MSG_VALIDATION_FAILED_BECAUSE_OF_EXCEPTION";

    public final static String MSG_INVALID_VALIDATION_FUNCTION_RETURN_TYPE =
    ...
    public final static String MSG_UNEXPECTED_EXCEPTION_WHILE_WRITING_OUTPUT =
            "MSG_UNEXPECTED_EXCEPTION_WHILE_WRITING_OUTPUT";

    public final static String MSG_MISSING_SAX_TRANSFORMER = "MSG_MISSING_SAX_TRANSFORMER";

    public final static String MSG_TEMPLATE_CONTAINS_NON_STATIC_STATEMENTS =
            "MSG_TEMPLATE_CONTAINS_NON_STATIC_STATEMENTS";
    ...
    public final static String MSG_ERROR_CREATING_DIRECTORY = "MSG_ERROR_CREATING_DIRECTORY";
    ...
    public final static String MSG_RELATIVE_PREFIX_REQUIRES_ABSOLUTE_PREFIX = "MSG_RELATIVE_PREFIX_REQUIRES_ABSOLUTE_PREFIX";

    public final static String MSG_ABSOLUTE_PREFIX_REQUIRES_ABSOLUTE_PATH = "MSG_ABSOLUTE_PREFIX_REQUIRES_ABSOLUTE_PATH";
    ...
    public final static String MSG_INVALID_FIRST_ARG_SUBSTITUTE = "MSG_INVALID_FIRST_ARG_SUBSTITUTE";

    public final static String MSG_INVALID_SECOND_ARG_SUBSTITUTE = "MSG_INVALID_SECOND_ARG_SUBSTITUTE";

    public final static String MSG_INVALID_SUBSTITUTE_VARIABLE = "MSG_INVALID_SUBSTITUTE_VARIABLE";

    public final static String MSG_SUBSTITUTE_VARIABLE_UNDEFINED = "MSG_SUBSTITUTE_VARIABLE_UNDEFINED";
    ...
    public final static String MSG_ARG_NOT_PROPERTY = "MSG_ARG_NOT_PROPERTY";

    public final static String MSG_INVALID_RADIX = "MSG_INVALID_RADIX";

    public final static String MSG_INVALID_RADIX_TYPE = "MSG_INVALID_RADIX_TYPE";
    ...
    /**
     * Class contains only static utilities, so ensure that no instances of this class are created.
     */
    ...
    public static String getMessageString(String msgKey) {
        ...
        try {
            ...
            throw new CompilerError("bundle contains non-string object for key '" + msgKey + "'");
        }
    }
