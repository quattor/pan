/*
 ...
 $HeadURL: https://svn.lal.in2p3.fr/LCG/QWG/panc/trunk/src/org/quattor/pan/dml/functions/Return.java $
 $Id: Return.java 2799 2008-01-26 17:10:23Z loomis $
 */
...
final public class Return extends BuiltInFunction {
	...
	public static Operation getInstance(SourceRange sourceRange,
		...
		if (operations.length != 1) {
			throw SyntaxException
					.create(sourceRange, MSG_ONE_ARG_REQ, "return");
		}

		return new Return(sourceRange, operations);
	}
	...
	public Element execute(Context context) {
		...
		// Simply throw the return value back up the execution stack. Function
		// calls and the top-level DML block will catch this exception and do
		// the right thing.
		throw new ReturnValueException(ops[0].execute(context));
	}
