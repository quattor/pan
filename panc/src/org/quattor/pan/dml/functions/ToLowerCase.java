...
final public class ToLowerCase extends BuiltInFunction {
	...
	public static Operation getInstance(SourceRange sourceRange,
		...
		return new ToLowerCase(sourceRange, operations);
	}
	...
	public Element execute(Context context) {
		...
		try {
			...
			return StringProperty.getInstance(s.toLowerCase(Locale.US));
		} catch (ClassCastException cce) {
			throw new EvaluationException(
					"invalid argument to to_lowercase(); string required",
					sourceRange, context);
		}
	}
