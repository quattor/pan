...
public class TracebackSuppressedTest extends BuiltInFunctionTestUtils {

	@Test
	public void checkGetInstance() {
		checkClassRequirements(Traceback.class);
	}

	@Test(expected = SyntaxException.class)
	public void checkTooFewArguments() throws SyntaxException {
		TracebackSuppressed.getInstance(null);
	}

	@Test(expected = SyntaxException.class)
	public void checkTooManyArguments() throws SyntaxException {
		TracebackSuppressed.getInstance(null, StringProperty.getInstance("OK"),
				StringProperty.getInstance("BAD"));
	}

	@Test(expected = SyntaxException.class)
	public void checkInvalidArgument() throws SyntaxException {
		TracebackSuppressed.getInstance(null, LongProperty.getInstance(0L));
	}
