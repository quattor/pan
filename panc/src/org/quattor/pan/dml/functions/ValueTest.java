...
public class ValueTest extends BuiltInFunctionTestUtils {

	@Test
	public void checkGetInstance() {
		checkClassRequirements(Value.class);
	}
	...
	public void verifyNoCompileTimeEval() throws SyntaxException {
		...
		Operation op = Value.getInstance(null, StringProperty
				.getInstance("alpha:/some/path/value"));
