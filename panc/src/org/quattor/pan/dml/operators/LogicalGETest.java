/*
 ...
 $HeadURL: https://svn.lal.in2p3.fr/LCG/QWG/panc/trunk/src/org/quattor/pan/dml/operators/LogicalGETest.java $
 $Id: LogicalGETest.java 3550 2008-08-02 14:54:26Z loomis $
 */
...
public class LogicalGETest extends AbstractOperationTestUtils {
	...
	public void testLongs() throws SyntaxException {
		...
		Operation lge = LogicalGE.newOperation(null, LongProperty
				.getInstance(va), LongProperty.getInstance(vb));

		// Pull the value off the stack.
		assertTrue(lge instanceof BooleanProperty);
		BooleanProperty result = (BooleanProperty) lge;
	...
	public void testDoubles() throws SyntaxException {
		...
		// Execute the operations.
		Operation lge = LogicalGE.newOperation(null, DoubleProperty
	...
	public void testString() throws SyntaxException {
		...
		// Execute the operations.
		Operation lge = LogicalGE.newOperation(null, StringProperty
