/*
 ...
 $HeadURL: https://svn.lal.in2p3.fr/LCG/QWG/panc/trunk/src/org/quattor/pan/dml/operators/LogicalLT.java $
 $Id: LogicalLT.java 3515 2008-07-31 13:20:05Z loomis $
 */

package org.quattor.pan.dml.operators;

import static org.quattor.pan.utils.MessageUtils.MSG_INVALID_ARGS_LT;
import static org.quattor.pan.utils.MessageUtils.MSG_MISMATCHED_ARGS_LT;
 ...
 * 
 */
final public class LogicalLT extends AbstractOperation {

	private static final long serialVersionUID = 5765673786558509905L;

	private LogicalLT(SourceRange sourceRange, Operation... operations) {
		...
		if (ops[0] instanceof Element && ops[1] instanceof Element) {
			...
			try {
				...
				throw new EvaluationException(MessageUtils
						.format(MSG_INVALID_ARGS_LT), sourceRange);
			} catch (EvaluationException ee) {
				throw SyntaxException.create(sourceRange, ee);
			}

		} else {
			result = new LogicalLT(sourceRange, ops);
		}
	...
	private static Element execute(SourceRange sourceRange, Property a,
		...
		if ((a instanceof NumberProperty) && (b instanceof NumberProperty)) {
			...
			throw new EvaluationException(MessageUtils
					.format(MSG_MISMATCHED_ARGS_LT), sourceRange);
		}
