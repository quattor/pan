/*
 ...
 $HeadURL: https://svn.lal.in2p3.fr/LCG/QWG/panc/trunk/src/org/quattor/pan/dml/operators/Mult.java $
 $Id: Mult.java 3515 2008-07-31 13:20:05Z loomis $
 */

package org.quattor.pan.dml.operators;

import static org.quattor.pan.utils.MessageUtils.MSG_INVALID_ARGS_MULT;
...
/**
 * Implements a multiplication operation for longs and doubles. If one of the
 * arguments is a double, the result is a double. Otherwise, the result is a
 * long.
 * 
 * @author loomis
 * 
		...
		if (ops[0] instanceof Element && ops[1] instanceof Element) {
			...
			try {
				...
				throw new EvaluationException(MessageUtils
						.format(MSG_INVALID_ARGS_MULT), sourceRange);
