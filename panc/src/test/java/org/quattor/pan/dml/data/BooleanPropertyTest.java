/*
 ...
 $Id: BooleanPropertyTest.java 3550 2008-08-02 14:54:26Z loomis $
 */

package org.quattor.pan.dml.data;

public class BooleanPropertyTest extends PropertyTestParent {

	@Override
	public Element getTestElement() {
		return BooleanProperty.getInstance(true);
	}
