...
public class PrependTest extends BuiltInFunctionTestUtils {

	@Test
	public void checkGetInstance() {
		checkClassRequirements(Prepend.class);
	}

	@Test(expected = SyntaxException.class)
	public void testTooFewArguments() throws SyntaxException {
		Prepend.getInstance(null);
	}

	@Test(expected = SyntaxException.class)
	public void testTooManyArguments() throws SyntaxException {
		Prepend.getInstance(null, new ListResource(), StringProperty
	...
	public void testInvalidFirstArg() throws SyntaxException {
		Prepend.getInstance(null, StringProperty.getInstance("BAD"),
	...
	@Test
	public void testPrependToProtectedList() throws SyntaxException,
