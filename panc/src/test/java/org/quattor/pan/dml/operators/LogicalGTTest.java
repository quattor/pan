/*
 ...
 $HeadURL: https://svn.lal.in2p3.fr/LCG/QWG/panc/trunk/src/org/quattor/pan/dml/operators/LogicalGTTest.java $
 $Id: LogicalGTTest.java 3550 2008-08-02 14:54:26Z loomis $
 */
...
public class LogicalGTTest extends AbstractOperationTestUtils {
	...
	public void testLongs() throws SyntaxException {
		...
		Operation lgt = LogicalGT.newOperation(null, LongProperty
				.getInstance(va), LongProperty.getInstance(vb));

		// Pull the value off the stack.
		assertTrue(lgt instanceof BooleanProperty);
		BooleanProperty result = (BooleanProperty) lgt;
	...
	public void testDoubles() throws SyntaxException {
		...
		// Execute the operations.
		Operation lgt = LogicalGT.newOperation(null, DoubleProperty
	...
	public void testString() throws SyntaxException {
		...
		// Execute the operations.
		Operation lgt = LogicalGT.newOperation(null, StringProperty
