/*
 ...
 $HeadURL: https://svn.lal.in2p3.fr/LCG/QWG/panc/trunk/src/org/quattor/pan/dml/operators/LogicalLTTest.java $
 $Id: LogicalLTTest.java 3550 2008-08-02 14:54:26Z loomis $
 */
...
public class LogicalLTTest extends AbstractOperationTestUtils {
	...
	public void testLongs() throws SyntaxException {
		...
		Operation llt = LogicalLT.newOperation(null, LongProperty
				.getInstance(va), LongProperty.getInstance(vb));

		// Pull the value off the stack.
		assertTrue(llt instanceof BooleanProperty);
		BooleanProperty result = (BooleanProperty) llt;
	...
	public void testDoubles() throws SyntaxException {
		...
		// Execute the operations.
		Operation llt = LogicalLT.newOperation(null, DoubleProperty
	...
	public void testString() throws SyntaxException {
		...
		// Execute the operations.
		Operation llt = LogicalLT.newOperation(null, StringProperty
