/*
 ...
 $HeadURL: https://svn.lal.in2p3.fr/LCG/QWG/panc/trunk/src/org/quattor/pan/dml/operators/SubTest.java $
 $Id: SubTest.java 3550 2008-08-02 14:54:26Z loomis $
 */
...
public class SubTest extends AbstractOperationTestUtils {
	...
	public void testLongs() throws SyntaxException {
		...
		Operation sub = Sub.newOperation(null, LongProperty.getInstance(va),
				LongProperty.getInstance(vb));

		// Pull the value off the stack.
		assertTrue(sub instanceof LongProperty);
		LongProperty result = (LongProperty) sub;
	...
	public void testDoubles() throws SyntaxException {
		...
		Operation sub = Sub.newOperation(null, DoubleProperty.getInstance(va),
				DoubleProperty.getInstance(vb));

		// Pull the value off the stack.
		assertTrue(sub instanceof DoubleProperty);
		DoubleProperty result = (DoubleProperty) sub;
